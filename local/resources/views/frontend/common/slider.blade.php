    ...
    <div id="carouselExampleControls" class="carousel slide carousel-fade slider-carousel" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="edit-slide slider1" style="background:url('{{URL::to('images/slider/image-1.jpg')}}')">
            ...
            <div class="carousel-item">
                <div class="edit-slide slider2" style="background:url('{{URL::to('images/slider/image-2.jpg')}}')">
            ...
            <div class="carousel-item">
                <div class="edit-slide slider3" style="background:url('{{URL::to('images/slider/image-3.jpg')}}')">
