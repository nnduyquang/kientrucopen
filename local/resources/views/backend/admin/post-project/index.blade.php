...
@section('container')
    <div class="col-lg-12 ">
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                ...
                <a class="btn btn-success" href="{{ route('post-project.create') }}"> Tạo Mới Bài Viết</a>
                @endpermission
            </div>
        </div>
    </div>
    ...
    @endif
    {!! Form::open(array('route' => 'post-project.search','method'=>'POST','id'=>'formSearchPost')) !!}
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6">
        ...
        <table class="table table-bordered">
            ...
            @foreach ($posts as $key => $data)
                ...
                <td>
                    ...
                    <a class="btn btn-primary" href="{{ route('post-project.edit',$data->id) }}">Cập Nhật</a>
                    @endpermission
                    @permission(('post-delete'))
                    {!! Form::open(['method' => 'DELETE','route' => ['post-project.destroy', $data->id],'style'=>'display:inline']) !!}
